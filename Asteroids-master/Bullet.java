...
public class Bullet extends SmoothMover
{
    ...
    /**
     * This method checks to see if the asteroid has
     * been hit. If the asteroid has been hit
     * it will disapear from the world.
     *               
     * @param There are no parameters     
     * @return Nothing is being returned     
     */
    //TODO (80): Declare a method called checkAsteroidHit that does not return anything and has no parameters
    private void checkAsteroidHit()
    {
         //TODO (81): Declare a local Asteroid variable called asteroid that is initialized to a casted reference of one intersecting object of the Asteroid class
